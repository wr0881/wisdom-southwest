<template>
    <div class="circle-progress" :style="{'width':circleRadius*2+'px','height':circleRadius*2+'px'}">
        <canvas class="circle-canvas" ref="circle1" :width="circleRadius*2" :height="circleRadius*2"></canvas>
        <canvas class="percent-canvas" ref="percent1" :width="circleRadius*2" :height="circleRadius*2"></canvas>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        drawPercent() {
        //画文字百分比
        let percent = this.$refs.percent1;
