<template>
    <div class="circle-progress" :style="{'width':circleRadius*2+'px','height':circleRadius*2+'px'}">
        <canvas class="circle-canvas" ref="circle" :width="circleRadius*2" :height="circleRadius*2"></canvas>
        <canvas class="percent-canvas" ref="percent" :width="circleRadius*2" :height="circleRadius*2"></canvas>
    </div>
</template>
