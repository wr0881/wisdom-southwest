<template>
    <div class="contBox">
        <div class="map-box">
            ...
            <div class="map-title">风险分布图</div>
            <div class="layer">
                <div class="layer-box"><div class="icon-layerbox hospital"></div>医院</div>
                <div class="layer-box"><div class="icon-layerbox firecontrol"></div>消防</div>
                <div class="layer-box"><div class="icon-layerbox warehouse"></div>应急仓库</div>
            </div>
...
.layer {
    ...
    .layer-box {
        ...
        .hospital {
            background-image: url('../../assets/imgs/safety/icon_hospital.png');
            background-repeat: no-repeat;
            background-size: 100% 100%;
            background-position: 0 0;
        }
        .firecontrol {
            background-image: url('../../assets/imgs/safety/icon_firecontrol.png');
            background-repeat: no-repeat;
            background-size: 100% 100%;
            background-position: 0 0;
        }
        .warehouse {
            background-image: url('../../assets/imgs/safety/icon_warehouse.png');
            background-repeat: no-repeat;
            background-size: 100% 100%;
            background-position: 0 0;
        }
